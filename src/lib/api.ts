...
export interface BatteryHealth { days: number; ratedKwh: number | null; capKwh: number | null; soh: number | null; cycles: number | null; dischargeKwh: number; dod: { avg: number | null; minSoc: number | null; lowDays: number }; trend: { day: string; capKwh: number; segments: number }[]; firstCapKwh: number | null; nominalV?: number | null; ratedAh?: number | null; }
