...
- **แจ้งเตือนออกนอกแอป (optional)** — Discord webhook / Telegram: อินเวอร์เตอร์ออฟไลน์ · Deye alarm เกิด/หาย · ดึง Deye ไม่ได้ติดกัน · กลางวันแต่ไม่ผลิตไฟ (ตัดช่วงฝนตก) · ไฟกริดหาย · แบตต่ำ · จุดผิดปกติจากการวิเคราะห์ — ส่ง "กลับมาปกติ" เมื่อหาย
